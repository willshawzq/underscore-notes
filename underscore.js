...
(function() {
  ...
  function createReduce(dir) {
    ...
    // 这里是第一层闭包持久化iterator函数，调用reduce和reduceRight函数避免重复新建函数
  ...
  var eq = function(a, b, aStack, bStack) {
    ...
    // 这里为了区分’+0’和’-0’,不知为何，目前自己测试，并没发现对计算结果有何影响
    ...
    switch (className) {
      ...
      case '[object Date]'://日期对象前面加‘+’能转换成数字
      case '[object Boolean]'://boolean对象前面加‘+’能转换成数字
...
}.call(this));//这里将window对象传入到了方法体内，效果和(function(w){})(window)类似
